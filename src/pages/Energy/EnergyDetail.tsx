...
const EnergyDetail = () => {
  ...
  return (
    <>
      ...
      <BtnContainer>
        <LikeBtn isLike={likeArr.includes(parseInt(params.energy_id!)) ? true : false} setIsLike={() => setLike(parseInt(params.energy_id!))} />
        <Button name="구매하기" status="energy" onClick={() => setIsOpen(true)} />
      </BtnContainer>
      {isOpen && (
